...
pub fn validate_inputs<'info>(sig: String, expect: &str, to: AccountInfo<'info>, authority: AccountInfo<'info>, mint: AccountInfo<'info>, program: AccountInfo<'info>, bumps: u8) -> Result<()> {
